...
pursuing a B2B with a focus on [Cyber and Info Security Tech]. 
 
## 📋 About Me 
- 🏫 Student at ECPI University 
- 🎯 Interests: [e.g., Penetration Testing, Network Defense, SOC Analysis] 
- 📜 Certifications: [e.g., CompTIA Security+, in progress] 
- 📧 Contact: [itkim@protonmail.com] 
 
## 📂 Portfolio Contents 
| Folder | Description | 
|--------|-------------| 
| labs/  | Hands-on lab work by topic | 
